...
#initialise Paddle (player controllable rectangle)
...
#intialise Ball and its movements
...
#main function -- performs main game logic
class Pong:
    #default screen size
    HEIGHT = 540
    WIDTH = 960
    ...
    #color of ball and paddles is white #ffffff
    COLOUR = (255, 255, 255)
    ...
    #check if ball hits wall and deflect accordingly
    ...
    #check if ball hits paddle and deflect accordingly
